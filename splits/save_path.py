...
instance_base_directory = '/data1/users/zhengzhiyu/mtp_workplace/dataset/MOTA/split_ss_dota1_0/'

imgs_directory1 = os.path.join(instance_base_directory, 'val/images/')
masks_directory1 = os.path.join(instance_base_directory, 'val/new_labels/')

output_file = '/data1/users/zhengzhiyu/ssl_workplace/S5/splits/isaid_ori/val.txt'
