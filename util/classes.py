...
CLASSES = {'pascal': ['background', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 
           ...
           'IRSAMap': ['Other ', 'Cropland', 'Tree ', 'Grass', 'water', 'Building', 'Road'],

           'levir': ['unchanged', 'changed'],

           'whu': ['unchanged', 'changed'],

           'oscd': ['unchanged', 'changed'],

           'terrain': ['background', 'buildings', 'roads', 'water', 'vegetation', 'barren'],

           'OpenEarthMap': ['other ', 'Bareland', 'Grass ', 'Pavement', 'Road', 'Tree', 'water', 'Agriculture land', 'Building'],
           
           'uavid': ['Background ', 'Road', 'Building', 'Tree', 'Low vegetation', 'Moving car', 'Static car', 'Human'],

           'isaid': ['large_Vehicle', 'swimming_pool', 'helicopter', 'bridge', 'plane', 'ship', 
                        'soccer_ball_field', 'basketball_court', 'ground_Track_Field', 'small_Vehicle',
                        'baseball_diamond', 'tennis_court', 'roundabout', 'storage_tank', 'harbor', 'background'],
           'isaid_ori': ['background', 'ship', 'storage_tank', 'baseball_diamond', 'tennis_court', 'basketball_court', 
           ...
           'loveda': ['Background ', 'Building', 'Road ', 'Water', 'Barren', 'Barren', 'Agriculture'],
            ...
            'UDD': ['other ', 'Facade', 'Road', 'Vegetation', 'Vehicle', 'Roof'],
           ...
           'coco': ['void', 'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 
            ...
            'pretrain_cv': ['wall', 'building', 'sky', 'floor', 'tree', 'ceiling', 'road', 'bed ', 'windowpane', 'grass', 'cabinet',
