...
# from model.backbone.ViTAE_Window_NoShift.base_model import vitaev2_s
...
from model.semseg.modules import Activation

from model.semseg.upernet_mmseg_30 import UPerHead
    ...
    def __init__(self, 
        ...
        if args.backbone == 'resnet50':
            ...
            if args.init_backbone == 'rsp':
                ...
                self.encoder.init_weights('/data1/users/lvliang/project_123/ssl_pretrain/pretrained/swin_tiny_patch4_window7_224.pth')
