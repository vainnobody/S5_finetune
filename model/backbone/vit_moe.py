...
from mmcv.cnn.bricks.transformer import FFNMOE, MultiheadAttention
...
class ViT(BaseModule):
    ...
    def forward(self, inputs, dataset=None):
        ...
        # new_pos_embed = self.resize_pos_embed_1d(pos_embed, target_len)
...
def ViT_B_MOE(args):
    backbone = ViT(
        ...
        # task_names=['vaihingen', 'potsdam', 'OpenEarthMap', 'loveda', 'UDD', 'uavid'] 
    )
    return backbone
...
def ViT_L_MOE(args):
    backbone = ViT(
        ...
        part_features=args.part,
        task_names=args.tasks   
        # task_names=['vaihingen', 'potsdam', 'OpenEarthMap', 'loveda', 'UDD', 'VDD']    
    )
    return backbone
...
def ViT_H_MOE(args):
    backbone = ViT(
        ...
        part_features=args.part,
        # task_names=['vaihingen', 'potsdam', 'OpenEarthMap', 'loveda', 'UDD', 'uavid']    
        # task_names=['vaihingen', 'potsdam', 'OpenEarthMap', 'loveda']    
        task_names=args.tasks     
