...
def bflip(imgA, imgB, mask, p=0.5):
    if random.random() < p:
...
def Rotate(imgA, imgB, mask, p=0.5):  # [-30, 30]
    if random.random() < p:
...
def Rotate_90(imgA, imgB, mask, p=0.5):
    if random.random() < p:
        v = 90
        imgA = imgA.rotate(v)
        imgB = imgB.rotate(v)
...
def Rotate_180(imgA, imgB, mask, p=0.5):
    if random.random() < p:
        v = 180
        imgA = imgA.rotate(v)
        imgB = imgB.rotate(v)
...
def Rotate_270(imgA, imgB, mask, p=0.5):
    if random.random() < p:
        v = 270
        imgA = imgA.rotate(v)
        imgB = imgB.rotate(v)
